        ...
        <Form @submit="signup()" :validation-schema="schema" v-slot="{ errors }">
          <div class="sm:flex justify-between items-end sm:space-x-5 md:space-x-10">
            ...
            <div class="flex-1 text-end">
              ...
              <div v-if="imageUrl" class="relative mt-2 sm:mt-2 md:mt-4 w-16 sm:w-20 md:w-24 h-16 sm:h-20 md:h-24">
          ...
          <Field v-model="name" type="text" name="Name" id="name" class="input"
